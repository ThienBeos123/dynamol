...
uint8_t _vanillc_crt_gt(uint64_t x, uint64_t y) { return _lib_crt_lt(y, x); }
uint8_t _vanillc_crt_leq(uint64_t x, uint64_t y) { return _lib_crt_lt(x, y) ^ 1; }
uint8_t _vanillc_crt_geq(uint64_t x, uint64_t y) { return _lib_crt_gt(x, y) ^ 1; }
