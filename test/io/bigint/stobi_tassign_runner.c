...
scase ecases_bprefix[27] = { // 19 limbs ---> 152 bytes
    ...
    { /* 22.        |   "0x0"                           ---->   STR_SUCCESS (0)                     */
        ...
        .in = &(stobi_assign_in){ .str = "0xFF", .len = 4, .base = 0, .bi_size = BIGINT_CAP },
        .exp = { 
            .type = BIGINT, .status = STR_SUCCESS, .cap = 0,
...
int main(int argc, char **argv) { _libdnml_init();
    ...
    //* ---------------------------------- SUITE SETUP ---------------------------------- *//
    FILE *idk = fopen("logs/bigInt_tget_str.txt", "w"); fclose(idk);
    ...
    create_str_suite(&tget_str_suite, "bigInt_tget_str - String Assignment", 
        tassign_ecount, rcount, ecases_bprefix, INVERSE, ebuf_slices[0],
        "logs/bigInt_tget_str.txt", &tassign_ectx, &tassign_rcon,
    ...
    create_str_suite(&tget_strn_suite, "bigInt_tget_strn - String Assignment",
        tassign_ecount, rcount, ecases_bprefix, INVERSE, ebuf_slices[1],
        "logs/bigInt_tget_str.txt", &tassign_ectx, &tassign_rcon,
        &assign_bp_rconfig, &assign_rstate
    ...
    create_str_suite(&tget_strb_suite, "bigInt_tget_strb - String Assignment",
        tassign_ecount, rcount, ecases_bprefix, INVERSE, ebuf_slices[2],
        "logs/bigInt_tget_str.txt", &tassign_ectx, &tassign_rcon,
    ...
    create_str_suite(&tget_strnb_suite, "bigInt_tget_strnb - String Assignment",
        tassign_ecount, rcount, ecases_bprefix, INVERSE, ebuf_slices[3],
        "logs/bigInt_tget_str.txt", &tassign_ectx, &tassign_rcon,
        &assign_rconfig, &assign_rstate
