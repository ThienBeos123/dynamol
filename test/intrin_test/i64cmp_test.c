...
int main(void) {
    ...
    fputs("=========================================================\n", stdout);
    fputs("      RUNNING INTEGRATED UNIT TESTS - SIGNED COMP        \n", stdout);
    fputs("=========================================================\n", stdout);
    /* =============== Test: x < y =============== */
    fputs("--- Testing LTI64 (<) Architectures ---\n", stdout);
    for (size_t i = 0; i < 100; ++i) {
        int64_t x = global_bank[i].x, y = global_bank[i].y;
    ...
    /* =============== Test: x > y =============== */
    fputs("--- Testing GTI64 (>) Architectures ---\n", stdout);
    for (size_t i = 0; i < 100; ++i) {
    ...
    /* =============== Test: x <= y =============== */
    fputs("--- Testing LEQI64 (<=) Architectures ---\n", stdout);
    for (size_t i = 0; i < 100; ++i) {
        int64_t x = global_bank[i].x;
        int64_t y = global_bank[i].y;
