...
_dnml_hwcaps_rv64 libdnml_rv64_caps;
_dnml_hwcaps_x64 libdnml_x64_caps;
_dnml_hwcaps_arm64 libdnml_arm64_caps;
...
static void ___rv64_LINUX_detcaps(void) {
    ...
    if (!ret) {
        ...
        libdnml_rv64_caps.rv64_zbb = (ext & RISCV_HWPROBE_EXT_ZBB) != 0;
        libdnml_rv64_caps.rv64_zba = (ext & RISCV_HWPROBE_EXT_ZBA) != 0;
        return;
    }
#endif
}
...
static inline void ___rv64_BSD_detcaps(void) {
    ...
    libdnml_rv64_caps.rv64_zbb = (hwcap & HWCAP_ISA_B) != 0;
#endif
}
void __DNML_DETRV64_HWCAPS(void) {
    ...
    libdnml_rv64_caps.rv64_zbs = _DNML_BARE_RISCV_ZBS;
#endif
#endif
}


// x86_64 Extension detections -- WINDOWS 64
static inline void ___x86_WINdetcaps_bitex(void) {
#if __ARCH_X86_64__ && __OS_WIN64__
    int cpuInfo[4] = {0};
    // BMI1 Checking
    __cpuid(cpuInfo, 7) // Scan Page 0x00000007
    libdnml_x64_caps.x86_bmi1 = (cpuInfo[1] & dnml_bit_BMI1) != 0;
    // ABM Checking
    __cpuid(cpuInfo, 0x80000001);
    libdnml_x64_caps.x86_abm = (cpuInfo[2] & dnml_bit_ABM) != 0;
#endif
}
static inline void ___x86_WINdetcaps_simdex(void) {
#if __ARCH_X86_64__ && __OS_WIN64__
    int cpuInfo[4] = {0};
    libdnml_x64_caps.x86_sse4_2 = IsProcessorFeaturePresent(
        PF_SSE4_2_INSTRUCTIONS_AVAILABLE
    );
#endif
}
static inline void ___x86_WINdetcaps_secex(void) {
#if __ARCH_X86_64__ && __OS_WIN64__
    int cpuInfo[4] = {0};
    /* RDRAND Checking */ __cpuid(cpuInfo, 1);
    libdnml_x64_caps.x86_rdrand = (cpuInfo[2] & dnml_bit_RDRAND) != 0;
    /* RDSEED Checking */ __cpuid(cpuInfo, 7);
    libdnml_x64_caps.x86_rdseed = (cpuInfp[1] & dnml_bit_RDSEED) != 0;
#endif
}
...
static inline void ___x86_Pdetcaps_secex(void) {
    ...
    /* RDRAND Detection */ __sysv_get_cpuid(7, 0, det_registers);
    libdnml_x64_caps.x86_rdseed = (det_registers[1] & dnml_bit_RDSEED) != 0;
#endif
}
static inline void ___x86_Pdetcaps_simdex(void) {
    ...
    libdnml_x64_caps.x86_sse4_2 = (det_registers[2] & dnml_bit_SSE42) != 0;
#endif
}
static inline void ___x86_Pdetcaps_bitex(void) {
    ...
    if (max_instruct >= 0x80000001) {
        ...
        libdnml_x64_caps.x86_abm = (det_registers[2] & dnml_bit_ABM) != 0;
    } else libdnml_x64_caps.x86_abm = 0;
    if (max_instruct >= 7) {
        __sysv_get_cpuid(7, 0, det_registers);
        libdnml_x64_caps.x86_bmi1 = (det_registers[1] & dnml_bit_BMI1) != 0;
    } else libdnml_x64_caps.x86_bmi1 = 0;
#endif
}
...
// COMPILER INTRINSICS --- GCC / Clang
    ...
    libdnml_x64_caps.x86_sse4_2 = __builtin_cpu_supports("sse4.2");
    libdnml_x64_caps.x86_bmi1 = __builtin_cpu_supports("bmi");
    libdnml_x64_caps.x86_abm = __builtin_cpu_supports("abm");
#elif __compiler_msvc || defined(_WIN32)
    ___x86_WINdetcaps_bitex();
    ___x86_WINdetcaps_simdex();
    ___x86_WINdetcaps_secex();
    ...
    libdnml_x64_caps.x86_abm = _DNML_BARE_X86_ABM;
    libdnml_x64_caps.x86_bmi1 = _DNML_BARE_X86_BMI1;
    libdnml_x64_caps.x86_sse4_2 = _DNML_BARE_X86_SSE4_2;
#endif
#endif
}
