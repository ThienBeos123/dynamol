...
size_t __BIGINT_ASYM_TOOM6p5_WS__(size_t m_size, size_t n_size) { return 0; }
size_t __BIGINT_ASYM_TOOM7p5_WS__(size_t m_size, size_t n_size) { return 0; }
size_t __BIGINT_ASYM_TOOM8p5_WS__(size_t m_size, size_t n_size) { return 0; }
